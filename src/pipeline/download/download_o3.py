...
from pipeline.common.paths import INPUTS_O3_DATA_DIR, ensure_dir
...
def download_o3_packs(packs: list[int] | None = None):
    """Download the selected O3 packs into data/raw/o3."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Download O3 packs into data/raw/o3.")
    parser.add_argument(
        "--packs",
        type=str,
        default="all",
