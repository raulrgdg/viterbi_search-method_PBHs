...
from pipeline.common.paths import INPUTS_O3_DATA_DIR
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Renombra carpetas O3b-packX-512HZ a O3b-packX.")
    parser.add_argument("--base-dir", type=Path, default=INPUTS_O3_DATA_DIR, help="Directorio base que contiene las carpetas O3b-packX-512HZ.")
